...
public class DocsSugerencia {
    private String  c_compania ;
    private int n_sugerencia;
    private int n_linea ;
    ...
    public DocsSugerencia() {
    }

    public DocsSugerencia(String c_compania, int n_sugerencia, int n_linea, String c_descripcion, String c_nombre_archivo, String c_ruta_archivo, String c_ultimousuario, String d_ultimafechamodificacion) {
        this.c_compania = c_compania;
        this.n_sugerencia = n_sugerencia;
    ...
    public int getN_sugerencia() {
        return n_sugerencia;
    }

    public void setN_sugerencia(int n_sugerencia) {
        this.n_sugerencia = n_sugerencia;
    }

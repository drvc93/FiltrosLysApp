...
public class InsertDocsReclamoGarTask extends AsyncTask<String,String,String> {
    @Override
    protected String doInBackground(String... strings) {
        ...
        final String METHOD_NAME = "InsertDocsReclamoGar";
        ...
        try {
            ...
            Log.i("Result Insert  Docs RG. > ", res);
            result = res;


        } catch (Exception e) {
            result = e.getMessage();
            Log.i("Error Insert  Docs RG. > ", e.getMessage());
        }

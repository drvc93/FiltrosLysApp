...
public class InsertDocsCapacitacionTask extends AsyncTask<String,String,String> {
    ...
    protected String doInBackground(String... strings) {
        ...
        final String METHOD_NAME = "InsertDocsCapacitacion";
        ...
        try {
            ...
            Log.i("Result Insert  Docs CP. > ", res);
            result = res;


        } catch (Exception e) {
            result = e.getMessage();
            Log.i("Error Insert  Docs CP. > ", e.getMessage());
        }

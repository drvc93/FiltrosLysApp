...
public class GetListaDatosFotosRG extends AsyncTask<String,String,ArrayList<DocsReclamoGarantia>> {
    ArrayList<DocsReclamoGarantia> result;
    @Override
    protected ArrayList<DocsReclamoGarantia> doInBackground(String... strings) {
        ArrayList<DocsReclamoGarantia> LstData = new ArrayList<DocsReclamoGarantia>();
        final String NAMESPACE = Constans.NameSpaceWS;
        final String URL = Constans.UrlServer;
        final String METHOD_NAME = "GetListFotosRG";
        ...
        try {
            ...
            Log.i("result get lista datos fotos tg ", resSoap.toString());
            for (int i = 0; i < num_projects; i++) {
                ...
                oEnt.setN_numero( Integer.valueOf( ic.getPrimitivePropertyAsString("n_numero")));
            ...
            Log.i("AsynckTask get lista datos fotos tg ---", e.getMessage());
        }
        return result;
    }
}

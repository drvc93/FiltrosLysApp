...
public class AprobarSolicitudServTask extends AsyncTask<String ,String,String> {
    ...
    protected String doInBackground(String... strings) {
        ...
        final String METHOD_NAME = "AprobarSolcitudServ";
        ...
        try {
            ...
            Log.i("Result Aprobacion Solicitud> ", res);
            result = res;


        } catch (Exception e) {
            result = e.getMessage();
            Log.i(" Nro Aprobacion Solicitud > ", e.getMessage());
        }

...
public class InsertDocsQuejaClienteTask extends AsyncTask<String,String,String> {
    @Override
    protected String doInBackground(String... strings) {
        ...
        final String METHOD_NAME = "InsertDocsQuejaCliente";
        ...
        try {
            ...
            Log.i("Result Insert  Docs QJ. > ", res);
            result = res;


        } catch (Exception e) {
            result = e.getMessage();
            Log.i("Error Insert  Docs QJ. > ", e.getMessage());
        }
